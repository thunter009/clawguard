...
### Added
- HTTP reverse proxy with axum: `/health` endpoint, origin validation, cost limiting, upstream proxying
- `/scan` endpoint with embedding-based content scanner for skill analysis
- Source-based `/route` model selection for dynamic request routing
